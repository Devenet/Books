...
abstract class Path {
	...
	static function menu($active) {
		return self::url('home', 'All', $active).self::url('best', 'Best rated', $active).self::url('soon', 'Read list', $active).'<li class="rss"><a href="./books.rss" class="tip" title="RSS&nbsp;feed" rel="external"><i class="icon-rss"></i></a></li>'.PHP_EOL;
	}
